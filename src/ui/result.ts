...
<body>
  ...
  <script>
    // ── Dependency Health Hydration ─────────────────────────────────
    (function() {
      var VERDICT_COLORS = { healthy:'#22c55e', stable:'#eab308', degraded:'#f97316', critical:'#ef4444', unmaintained:'#6b7280', pending:'#8b8b9e', unresolved:'#55556a' };
      var VERDICT_EMOJI = { healthy:'✅', stable:'🟡', degraded:'⚠️', critical:'🔴', unmaintained:'⚫', pending:'⏳', unresolved:'❓' };
      ...
      function renderRow(dep) {
        ...
        return '<tr class="dep-row" data-score="' + (dep.score ?? -1) + '" data-verdict="' + dep.verdict + '">'
      ...
      function loadDeps() {
        fetch('/_data/deps/github/${encodedOwner}/${encodedRepo}')
