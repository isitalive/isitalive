    ...
    schemas: {
      HealthCheckResult: {
        ...
        properties: {
          ...
          verdict: {
            type: 'string',
            enum: ['healthy', 'maintained', 'declining', 'at_risk', 'abandoned'],
            description: 'Human-readable verdict based on score: healthy (80-100), maintained (60-79), declining (40-59), at_risk (20-39), abandoned (0-19)',
          },
          checkedAt: {
            type: 'string',
            format: 'date-time',
