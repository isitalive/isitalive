/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: dec80767cd52506390b6b7e00b241216)
// Runtime types generated with workerd@1.20260317.1 2025-03-14 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	type IsitaliveProviderEventsV2StreamRecord = { domain: string; id: string; timestamp: string; provider: string; owner: string; repo: string; archived: boolean; description?: string; stars: number; forks: number; default_branch?: string; license?: string; homepage_url?: string; language?: string; language_color?: string; last_commit_date?: string; last_release_date?: string; issue_staleness_median_days?: number; pr_responsiveness_median_days?: number; open_issue_count: number; closed_issue_count: number; open_pr_count: number; recent_contributor_count: number; top_contributor_commit_share: number; has_ci: boolean; last_ci_run_date?: string; ci_run_success_rate?: number; ci_run_count: number };
	type IsitaliveResultEventsV2StreamRecord = { domain: string; id: string; timestamp: string; project: string; score: number; verdict: string; source: string; signal_last_commit_score?: number; signal_last_commit_value?: string; signal_last_release_score?: number; signal_last_release_value?: string; signal_issue_staleness_score?: number; signal_issue_staleness_value?: string; signal_pr_responsiveness_score?: number; signal_pr_responsiveness_value?: string; signal_recent_contributors_score?: number; signal_recent_contributors_value?: string; signal_stars_score?: number; signal_stars_value?: string; signal_ci_score?: number; signal_ci_value?: string; signal_bus_factor_score?: number; signal_bus_factor_value?: string };
	type IsitaliveUsageEventsStreamRecord = { domain: string; type: string; id: string; timestamp: string; repo: string; provider: string; score: number; verdict: string; source: string; api_key?: string; cache_status?: string; response_time_ms?: number; country?: string; user_agent?: string; ip_hash?: string };
	type IsitaliveManifestEventsStreamRecord = { domain: string; type: string; id: string; timestamp: string; manifest_hash: string; format: string; dep_count: number; avg_score: number; conclusion: string; trigger: string; installation_id?: number; repo?: string; pr_number?: number };
	interface Env {
		...
		ASSETS: Fetcher;
		PROVIDER_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.IsitaliveProviderEventsV2StreamRecord>;
		RESULT_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.IsitaliveResultEventsV2StreamRecord>;
		USAGE_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.IsitaliveUsageEventsStreamRecord>;
		MANIFEST_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.IsitaliveManifestEventsStreamRecord>;
